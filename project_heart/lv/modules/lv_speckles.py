...
class LV_Speckles(LV_RegionIdentifier):
    ...
    def __init__(self, enums={}, *args, **kwargs):
        super(LV_Speckles, self).__init__(*args, **kwargs)
    ...
    def create_speckles(self,
                        ...
                        group:str=None,
                        collection:str=None,
                        from_nodeset:str=None,
                        exclude_nodeset:str=None,
                        use_all_nodes:bool=False, # will ignore 'd', k, kmin, kmax -- NEED TO IMPLEMENT
                        normal_to:np.ndarray=None,
                        perpendicular_to:np.ndarray=None,
                        d:float=3.0,
                        k:float=1.0,
                        kmin:float=None,
                        kmax:float=None,
                        extrapolate_k:bool=False,
                        use_local_k_ref:bool=False,
                        n_subsets:int=0, 
