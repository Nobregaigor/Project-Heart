...
def get_lv_typeA(filepath=filepath,statesfile=statesfile, save_spk_dict=False):
    ...
    apex_endo_spk = lv.create_speckles(
            collection="LA",
            group="endo",
            name="apex",
            from_nodeset=LV_SURFS.ENDO,
    ...
    base_endo_spk = lv.create_speckles(
                collection="LA",
                group="endo",
                name="base",
                from_nodeset=LV_SURFS.ENDO,
    ...
    apex_epi_spk = lv.create_speckles(
                collection="LA",
                group="epi",
                name="apex",
                from_nodeset=LV_SURFS.EPI,
    ...
    base_epi_spk = lv.create_speckles(
                collection="LA",
                group="epi",
                name="base",
                from_nodeset=LV_SURFS.EPI,
    ...
    if save_spk_dict:
        import json
        with open("./spk_args_lv_typeA.json", "w") as jfile:
