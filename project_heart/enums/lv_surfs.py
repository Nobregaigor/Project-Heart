...
class LV_FIBERS(Enum):
    # FIBER DATA
    FIBERS = LV_MESH_DATA.FIBERS
    F0 = LV_MESH_DATA.FIBERS
    SHEET = LV_MESH_DATA.SHEET
    S0 = LV_MESH_DATA.SHEET
    SHEET_NORMAL = LV_MESH_DATA.SHEET_NORMAL
    N0 = LV_MESH_DATA.SHEET_NORMAL
    # ANGLES
    FIBER_ANGLES = LV_MESH_DATA.FIBER_ANGLES
    F0_ANGLES = LV_MESH_DATA.FIBER_ANGLES
    SHEET_ANGLES = LV_MESH_DATA.SHEET_ANGLES
    S0_ANGLES = LV_MESH_DATA.SHEET_ANGLES
    SHEET_NORMAL_ANGLES = LV_MESH_DATA.SHEET_NORMAL_ANGLES
    N0_ANGLES = LV_MESH_DATA.SHEET_NORMAL_ANGLES
